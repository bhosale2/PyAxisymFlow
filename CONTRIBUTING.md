# Contributing to PyAxisymFlow

Thanks for taking the time to contribute!

The following is a set of guidelines for contributing to PyAxisymFlow.
...
2. I'm struggling in using PyAxisymFlow for my project! - Please open the issue with the label `help wanted` and explain the details of the problem and issue. We would gladly reach you to assist.
3. How can I contribute!? - If you already wrote the patch, you can open a `pull request` with the changes to the `main` branch. Ensure the code passes the [formatting and styles](#formatting-and-styleguide). The PR should clearly describe the problem and solution. Include all relevant issue numbers if applicable.
...
```bash
conda create --name pyaxisymflow-dev
conda activate pyaxisymflow-dev
...
If you have a patch, make a `pull request` to the `main` branch.
...
* Include **additional details** as much as possible.
	...
	* Which **version of PyAxisymFlow and dependencies** was used.
...
If you are unsure regarding how to start contributing to PyAxisymFlow, you can look through `good first issue` and `help wanted` labels.
...
Ask any question about **how to use PyAxisymFlow and detail implementation** in the **issue with label:question**.
