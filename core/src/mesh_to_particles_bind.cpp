...
template <class Float>
void _mesh_to_particles_1D_mp4(
                               ...
                               )
{
    ...
    return mesh_to_particles_1D_mp4 <Float>(
...
template <class Float>
void _mesh_to_particles_2D_linear_kernel(
                                         ...
                                         )
{
    ...
    return mesh_to_particles_2D_linear_kernel <Float>(
...
template <class Float>
void _mesh_to_particles_2D_yang_smooth_three_point_kernel(
py::array_t<Float> & input_field_x,
py::array_t<Float> & input_field_y,
py::array_t<Float> & particle_positions_x,
py::array_t<Float> & particle_positions_y,
                                                          ...
                                                          )
{
    ...
    return mesh_to_particles_2D_yang_smooth_three_point_kernel <Float>(
           _input_field_x, input_field_x.shape(0), input_field_x.shape(1),
           _input_field_y, input_field_y.shape(0), input_field_y.shape(1),
    _particle_positions_x, particle_positions_x.shape(0), particle_positions_x.shape(1),
    _particle_positions_y, particle_positions_y.shape(0), particle_positions_y.shape(1),
...
template <class Float>
void _mesh_to_particles_2D_mp6(
py::array_t<Float> & input_field_x,
py::array_t<Float> & input_field_y,
py::array_t<Float> & particle_positions_x,
py::array_t<Float> & particle_positions_y,
                               ...
                               )
{
    ...
    return mesh_to_particles_2D_mp6 <Float>(
           _input_field_x, input_field_x.shape(0), input_field_x.shape(1),
           _input_field_y, input_field_y.shape(0), input_field_y.shape(1),
    _particle_positions_x, particle_positions_x.shape(0), particle_positions_x.shape(1),
    _particle_positions_y, particle_positions_y.shape(0), particle_positions_y.shape(1),
...
template <class Float>
void _mesh_to_particles_2D_unbounded_linear_kernel(
py::array_t<Float> & input_field_x,
py::array_t<Float> & input_field_y,
py::array_t<Float> & particle_positions_x,
py::array_t<Float> & particle_positions_y,
                                                   ...
                                                   )
{
    ...
    return mesh_to_particles_2D_unbounded_linear_kernel <Float>(
           _input_field_x, input_field_x.shape(0), input_field_x.shape(1),
           _input_field_y, input_field_y.shape(0), input_field_y.shape(1),
    _particle_positions_x, particle_positions_x.shape(0), particle_positions_x.shape(1),
    _particle_positions_y, particle_positions_y.shape(0), particle_positions_y.shape(1),
...
template <class Float>
void _mesh_to_particles_2D_unbounded_yang_smooth_three_point_kernel(
py::array_t<Float> & input_field_x,
py::array_t<Float> & input_field_y,
py::array_t<Float> & particle_positions_x,
py::array_t<Float> & particle_positions_y,
                                                                    ...
                                                                    )
{
    ...
    return mesh_to_particles_2D_unbounded_yang_smooth_three_point_kernel <Float>(
           _input_field_x, input_field_x.shape(0), input_field_x.shape(1),
           _input_field_y, input_field_y.shape(0), input_field_y.shape(1),
    _particle_positions_x, particle_positions_x.shape(0), particle_positions_x.shape(1),
    _particle_positions_y, particle_positions_y.shape(0), particle_positions_y.shape(1),
...
template <class Float>
void _mesh_to_particles_2D_unbounded_mp6(
py::array_t<Float> & input_field_x,
py::array_t<Float> & input_field_y,
py::array_t<Float> & particle_positions_x,
py::array_t<Float> & particle_positions_y,
                                         ...
                                         )
{
    ...
    return mesh_to_particles_2D_unbounded_mp6 <Float>(
           _input_field_x, input_field_x.shape(0), input_field_x.shape(1),
           _input_field_y, input_field_y.shape(0), input_field_y.shape(1),
    _particle_positions_x, particle_positions_x.shape(0), particle_positions_x.shape(1),
    _particle_positions_y, particle_positions_y.shape(0), particle_positions_y.shape(1),
...
PYBIND11_MODULE(mesh_to_particles, m) {
    ...
    mesh_to_particles_1D_mp4
    wrap_particles_around_2D_domain
    mesh_to_particles_2D_linear_kernel
    mesh_to_particles_2D_yang_smooth_three_point_kernel
    mesh_to_particles_2D_mp4
    mesh_to_particles_2D_mp6
    mesh_to_particles_2D_unbounded_linear_kernel
    mesh_to_particles_2D_unbounded_yang_smooth_three_point_kernel
    mesh_to_particles_2D_unbounded_mp4
    mesh_to_particles_2D_unbounded_mp6
    )pbdoc";
...
and so whichever is minimal between the strategy and size is chosen.)pbdoc");
    ...
    m.def("mesh_to_particles_1D_mp4", &_mesh_to_particles_1D_mp4<double>,
...
to see options)pbdoc");
    ...
    m.def("mesh_to_particles_2D_linear_kernel", &_mesh_to_particles_2D_linear_kernel<double>,
...
periodic domain)pbdoc");

    m.def("mesh_to_particles_2D_yang_smooth_three_point_kernel", &_mesh_to_particles_2D_yang_smooth_three_point_kernel<double>,
        py::arg("input_field_x").noconvert(), py::arg("input_field_y").noconvert(), py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("output_field_x").noconvert(), py::arg("output_field_y").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
...
mesh to particle interpolation using MP4 kernel in a 2D periodic domain)pbdoc");
    ...
    m.def("mesh_to_particles_2D_mp6", &_mesh_to_particles_2D_mp6<double>,
        py::arg("input_field_x").noconvert(), py::arg("input_field_y").noconvert(), py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("output_field_x").noconvert(), py::arg("output_field_y").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
mesh to particle interpolation using MP6 kernel in a 2D periodic domain)pbdoc");

    m.def("mesh_to_particles_2D_unbounded_linear_kernel", &_mesh_to_particles_2D_unbounded_linear_kernel<double>,
        py::arg("input_field_x").noconvert(), py::arg("input_field_y").noconvert(), py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("output_field_x").noconvert(), py::arg("output_field_y").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
mesh to particle interpolation using LinearKernel in a 2D
unbounded domain)pbdoc");

    m.def("mesh_to_particles_2D_unbounded_yang_smooth_three_point_kernel", &_mesh_to_particles_2D_unbounded_yang_smooth_three_point_kernel<double>,
        py::arg("input_field_x").noconvert(), py::arg("input_field_y").noconvert(), py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("output_field_x").noconvert(), py::arg("output_field_y").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
mesh to particle interpolation using YangSmoothThreePointKernel in a 2D
unbounded domain)pbdoc");
...
mesh to particle interpolation using MP4 kernel in a 2D unbounded domain)pbdoc");
    ...
    m.def("mesh_to_particles_2D_unbounded_mp6", &_mesh_to_particles_2D_unbounded_mp6<double>,
        py::arg("input_field_x").noconvert(), py::arg("input_field_y").noconvert(), py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("output_field_x").noconvert(), py::arg("output_field_y").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
mesh to particle interpolation using MP6 kernel in a 2D unbounded domain)pbdoc");
