...
void _particles_to_mesh_1D_mp4(
                               ...
                               )
{
    ...
    return particles_to_mesh_1D_mp4 <Float>(
...
template <class Float>
void _particles_to_mesh_2D_linear_kernel(
                                         ...
                                         )
{
    ...
    return particles_to_mesh_2D_linear_kernel <Float>(
...
template <class Float>
void _particles_to_mesh_2D_yang_smooth_three_point_kernel(
py::array_t<Float> & particle_positions_x,
py::array_t<Float> & particle_positions_y,
py::array_t<Float> & input_field_at_particle_positions,
py::array_t<Float> & output_field_at_mesh,
                                                          ...
                                                          )
{
    ...
    return particles_to_mesh_2D_yang_smooth_three_point_kernel <Float>(
    _particle_positions_x, particle_positions_x.shape(0), particle_positions_x.shape(1),
    _particle_positions_y, particle_positions_y.shape(0), particle_positions_y.shape(1),
_input_field_at_particle_positions, input_field_at_particle_positions.shape(0), input_field_at_particle_positions.shape(1),
    _output_field_at_mesh, output_field_at_mesh.shape(0), output_field_at_mesh.shape(1),
...
template <class Float>
void _particles_to_mesh_2D_mp6(
py::array_t<Float> & particle_positions_x,
py::array_t<Float> & particle_positions_y,
py::array_t<Float> & input_field_at_particle_positions,
py::array_t<Float> & output_field_at_mesh,
                               ...
                               )
{
    ...
    return particles_to_mesh_2D_mp6 <Float>(
    _particle_positions_x, particle_positions_x.shape(0), particle_positions_x.shape(1),
    _particle_positions_y, particle_positions_y.shape(0), particle_positions_y.shape(1),
_input_field_at_particle_positions, input_field_at_particle_positions.shape(0), input_field_at_particle_positions.shape(1),
    _output_field_at_mesh, output_field_at_mesh.shape(0), output_field_at_mesh.shape(1),
...
template <class Float>
void _particles_to_mesh_2D_unbounded_yang_smooth_three_point_kernel(
py::array_t<Float> & particle_positions_x,
py::array_t<Float> & particle_positions_y,
py::array_t<Float> & input_field_at_particle_positions,
py::array_t<Float> & output_field_at_mesh,
                                                                    ...
                                                                    )
{
    ...
    return particles_to_mesh_2D_unbounded_yang_smooth_three_point_kernel <Float>(
    _particle_positions_x, particle_positions_x.shape(0), particle_positions_x.shape(1),
    _particle_positions_y, particle_positions_y.shape(0), particle_positions_y.shape(1),
_input_field_at_particle_positions, input_field_at_particle_positions.shape(0), input_field_at_particle_positions.shape(1),
    _output_field_at_mesh, output_field_at_mesh.shape(0), output_field_at_mesh.shape(1),
...
template <class Float>
void _particles_to_mesh_2D_unbounded_linear_kernel(
py::array_t<Float> & particle_positions_x,
py::array_t<Float> & particle_positions_y,
py::array_t<Float> & input_field_at_particle_positions,
py::array_t<Float> & output_field_at_mesh,
                                                   ...
                                                   )
{
    ...
    return particles_to_mesh_2D_unbounded_linear_kernel <Float>(
    _particle_positions_x, particle_positions_x.shape(0), particle_positions_x.shape(1),
    _particle_positions_y, particle_positions_y.shape(0), particle_positions_y.shape(1),
_input_field_at_particle_positions, input_field_at_particle_positions.shape(0), input_field_at_particle_positions.shape(1),
    _output_field_at_mesh, output_field_at_mesh.shape(0), output_field_at_mesh.shape(1),
...
template <class Float>
void _particles_to_mesh_2D_unbounded_mp6(
py::array_t<Float> & particle_positions_x,
py::array_t<Float> & particle_positions_y,
py::array_t<Float> & input_field_at_particle_positions,
py::array_t<Float> & output_field_at_mesh,
                                         ...
                                         )
{
    ...
    return particles_to_mesh_2D_unbounded_mp6 <Float>(
    _particle_positions_x, particle_positions_x.shape(0), particle_positions_x.shape(1),
    _particle_positions_y, particle_positions_y.shape(0), particle_positions_y.shape(1),
_input_field_at_particle_positions, input_field_at_particle_positions.shape(0), input_field_at_particle_positions.shape(1),
    _output_field_at_mesh, output_field_at_mesh.shape(0), output_field_at_mesh.shape(1),
...
PYBIND11_MODULE(particles_to_mesh, m) {
    ...
    Methods
    -------
    particles_to_mesh_1D_mp4
    particles_to_mesh_2D_linear_kernel
    particles_to_mesh_2D_yang_smooth_three_point_kernel
    particles_to_mesh_2D_mp4
    particles_to_mesh_2D_mp6
    particles_to_mesh_2D_unbounded_yang_smooth_three_point_kernel
    particles_to_mesh_2D_unbounded_linear_kernel
    particles_to_mesh_2D_unbounded_mp4
    particles_to_mesh_2D_unbounded_mp6
    )pbdoc";

    py::options options;
    options.disable_function_signatures();

    m.def("particles_to_mesh_1D_mp4", &_particles_to_mesh_1D_mp4<double>,
...
particle to mesh interpolation using MP4 kernel in a 1D periodic domain)pbdoc");
    ...
    m.def("particles_to_mesh_2D_linear_kernel", &_particles_to_mesh_2D_linear_kernel<double>,
...
2D periodic domain)pbdoc");

    m.def("particles_to_mesh_2D_yang_smooth_three_point_kernel", &_particles_to_mesh_2D_yang_smooth_three_point_kernel<double>,
        py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("input_field_at_particle_positions").noconvert(), py::arg("output_field_at_mesh").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
...
2D periodic domain)pbdoc");
    ...
    m.def("particles_to_mesh_2D_mp4", &_particles_to_mesh_2D_mp4<double>,
        py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("input_field_at_particle_positions").noconvert(), py::arg("output_field_at_mesh").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
particle to mesh interpolation using MP4 kernel in a 2D periodic domain)pbdoc");

    m.def("particles_to_mesh_2D_mp6", &_particles_to_mesh_2D_mp6<double>,
        py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("input_field_at_particle_positions").noconvert(), py::arg("output_field_at_mesh").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
particle to mesh interpolation using MP6 kernel in a 2D periodic domain)pbdoc");

    m.def("particles_to_mesh_2D_unbounded_yang_smooth_three_point_kernel", &_particles_to_mesh_2D_unbounded_yang_smooth_three_point_kernel<double>,
        py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("input_field_at_particle_positions").noconvert(), py::arg("output_field_at_mesh").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
particle to mesh interpolation using YangSmoothThreePointKernel kernel in a
2D periodic domain)pbdoc");

    m.def("particles_to_mesh_2D_unbounded_linear_kernel", &_particles_to_mesh_2D_unbounded_linear_kernel<double>,
        py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("input_field_at_particle_positions").noconvert(), py::arg("output_field_at_mesh").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
particle to mesh interpolation using Linear kernel in a
2D periodic domain)pbdoc");
    ...
    m.def("particles_to_mesh_2D_unbounded_mp4", &_particles_to_mesh_2D_unbounded_mp4<double>,
        py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("input_field_at_particle_positions").noconvert(), py::arg("output_field_at_mesh").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
particle to mesh interpolation using MP4 kernel in a 2D unbounded domain)pbdoc");

    m.def("particles_to_mesh_2D_unbounded_mp6", &_particles_to_mesh_2D_unbounded_mp6<double>,
        py::arg("particle_positions_x").noconvert(), py::arg("particle_positions_y").noconvert(), py::arg("input_field_at_particle_positions").noconvert(), py::arg("output_field_at_mesh").noconvert(), py::arg("delta_x"), py::arg("delta_y"),
R"pbdoc(
particle to mesh interpolation using MP6 kernel in a 2D unbounded domain)pbdoc");
