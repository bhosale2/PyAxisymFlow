...
from pyaxisymflow.pyst_kernels.advection_flux import (
    gen_advection_flux_conservative_eno3_pyst_kernel,
    gen_advection_flux_non_conservative_eno3_pyst_kernel,
)
from pyaxisymflow.pyst_kernels.elementwise_ops import (
...
# TODO GET RID OF CODE REPEAT HERE!!


def gen_advection_timestep_euler_forward_non_conservative_eno3_pyst_kernel(
    real_t=np.float64, num_threads=False, fixed_grid_size=False
):
    # TODO expand docs
    """Advection (ENO3 stencil) Euler forward timestep generator."""
    ...
    advection_flux_non_conservative_eno3_pyst_kernel = (
        gen_advection_flux_non_conservative_eno3_pyst_kernel(
            real_t=real_t,
            fixed_grid_size=fixed_grid_size,
            num_threads=num_threads,
    ...
    def advection_timestep_euler_forward_non_conservative_eno3_pyst_kernel(
        field, advection_flux, velocity, dt_by_dx
    ):
        """Advection (ENO3 stencil) Euler forward timestep.
    ...
    return advection_timestep_euler_forward_non_conservative_eno3_pyst_kernel
